    ...
    <form>
        ...
        <div style="margin-left:25%;">
            ...
            <button class="btn btn-primary">
                <a href="admin_cs.php" style="color:white; text-decoration: none;">BSc in African Musicology</a>
            </button>
        ...
        <div class="container">
            ...
            <form>
                ...
                <div class="card-body" id="userstable" style="width: 100%;">
                    ...
                    <div id="searchresult">
                        <h5 style="background: black;color: white; text-align: center;"><b>BSc in African Musicology LISTS</b></h5>
                        <table id="admin" class="table-responsive-lg border_table" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-lg-center">Postal Code</th>
