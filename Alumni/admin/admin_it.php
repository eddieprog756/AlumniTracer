...
<body>
    <form>
        <div class="top_banner">
            <div class="in_banner" style="background-color:28a745;">
                <div class="logo">
      ...
      <button class="btn btn-dark">
        <a href="homead.php" style="color:skyblue; text-decoration: none;"><span class='icon-field'></span>Home</a>
      </button>

      <button class="btn btn-primary">
        <a href="admin_it.php" style="color:white; text-decoration: none;"></i>BSc in Business IT</a>
      </button>
      ...
      <button class="btn btn-dark">
        <a href="add_acc.php" style="color:skyblue; text-decoration: none;"><span class='icon-field'></span>Add Users</a>
      </button>
        ...
        <div class="container">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button onclick="window.print()" class="btn btn-dark">Print Id</button>
            ...
            <form>
                <div class="card-body" id="userstable" style="width: 100%;">
                    ...
                    <div id="searchresult">
                        <h5 style="background: darkgray;color: black; text-align: center;"><b>BSc in Business IT LISTS</b></h5>
                        ...
                        <table class="table-responsive-lg border_table" id="userstable" style="width: 100%;">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-lg-center"><select name="fetch" id="fetch">
                                            <option value="" selected="">Course & Batch</option>
                                            <option value="Batch 2021">Batch 2021</option>
                                                ...
                                                <option value="Batch 2029">Batch 2029</option>
                                                <option value="Batch 2030">Batch 2030</option>
                                        </select></th>
                                    <th class="text-lg-center"><select name="fetchval" id="fetchval">
                                            <option value="" selected="">Employability Status</option>
                            ...
                            <tbody>
                                ...
                                $result_count = mysqli_query($conn, "SELECT COUNT(*)as total_records FROM bsitgrad");
                                $total_records = mysqli_fetch_array($result_count);
                                $total_records = $total_records['total_records'];
                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                $second_last = $total_no_of_pages - 1;

                                $query = "SELECT * FROM bsitgrad LIMIT $offset,$total_records_per_page";
                                $count = 1;
                        ...
                        <div class="text-right">
                            <button class="btn btn-primary">
                                <a href="export_it.php" class="btn btn-link" target="_blank" onclick="return confirm('Do you want to Export data to Microsoft Excel?');" style="color:black;">EXPORT TO EXCEL?</a>
                            </button>
                        </div>
                    </div>
                </div>
