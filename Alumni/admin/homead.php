...
<head>
  ...
  <div>
    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha384-vp4dcukgysl4tz8ck0+0/Ba62xFN/0twTdjzKtuQznL4sv5Az5pepu6IaXumzj2v" crossorigin="anonymous">
...
<body>
  <div class="top_banner">
    <div class="in_banner" style="background-color:transparent;">
      <div class="logo">
        <img alt="" src="../admin/image//must.png" align="right" width="50%">
      </div>
      <!-- <img alt="" src="../admin/image//must.jpg" class="img-responsive img-thumbnail" width="40px" style="margin-top: 2%;"> -->
  ...
  <div>
    ...
    <div style="margin-left:25%;">
      <button class="btn btn-primary">
        <a href="homead.php" style="color:white; text-decoration: none;"><span class='icon-field'></span>Home</a>
      </button>

      <button class="btn btn-dark">
        <a href="admin_it.php" style="color:skyblue; text-decoration: none;"></i>BSc in Business IT</a>
      </button>

      <button class="btn btn-dark">
        <a href="admin_cs.php" style="color:skyblue; text-decoration: none;">BSc in African Musicology</a>
      </button>

      <button class="btn btn-dark">
        <a href="add_acc.php" style="color:white; text-decoration: none;"><span class='icon-field'></span>Add Users</a>
      </button>

      <button class="btn btn-dark">
        <a href="adminlog.php" style="color:skyblue; text-decoration: none;">Logout</a>
      </button>
    </div>
    <div class="cleaner">
    </div>
    ...
    <br>
    <h2 style="margin-left: 22%; width:55%; text-align: center; font-family: Trebuchet; font-size: 20px; background: #f2f2f2; border: solid 1px #eaeaea;">Reports of the alumni for employed,unemployed and their status!!</h2>

    <table>
      <td>
        <h5 style="width:500px; margin-left: 30%; background-color:skyblue; text-align: center;"> BUSINESS IT TOTAL RESPONSES: <?php
        ...
        <div style="width:500px; height: 30px; margin-left: 30%;  background-color:skyblue; text-align: center;  font-family: bold;"> <button> <a href="bsitemp.php">Total of : <?php
      ...
      <td class="" align="right">
        <h5 style="width:500px; text-align: center; margin-left: 35%; background-color:skyblue;"> AFRICAN MUSICOLOGY TOTAL RESPONSES : <?php
        ...
        <div style="width:500px; height: 30px; margin-left: 35%; background-color:skyblue; font-family: bold;  text-align: center; "> <button> Total of: <?php
    ...
    <table>
      <td class="">
        ...
        <div style="width:500px; height: 30px; margin-left: 30%; background-color:skyblue; font-family: bold;  text-align: center;"><button> Total work in: <?php
      ...
      <td class="" align="right">
        ...
        <div style="width:500px; height: 30px; margin-left: 35%; background-color:skyblue; font-family: bold;  text-align: center; "> <button>
            Total work in: <?php
    ...
    <table>
      <td class="">
        ...
        <div style="width:500px; height: 30px; margin-left: 30%; background-color:skyblue; font-family: bold;  text-align: center;"><button> Total of: <?php
    ...
    <table>
      <td>
        <div style="width: 400px; height: 300px; margin-left: 100%; transform: translateX(-50%); margin-bottom: 10%; background-color: #f5f5f5; border-radius: 15px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); font-family: Arial, sans-serif; text-align: center; display: flex; flex-direction: column; justify-content: center; align-items: center;">

          <h5><u>Total response in BSIT Batch (2019-2027)</u><br>
            <br> <?php
      ...
      <td class="" align="right">
        <div style="width: 400px; height: 300px; margin-left: 76%; margin-bottom: 10%; background-color: #f5f5f5; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); font-family: Arial, sans-serif; text-align: center; display: flex; flex-direction: column; justify-content: center; align-items: center;">
          <h5><u>Total response in African Musicology Batch</u><br>
            <br> <?php
