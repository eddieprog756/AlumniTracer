...
<body>
    ...
    <div class="in_banner" style="background-color:28a745;">
            <div class="logo">
                <img alt="" src="../admin/image//must.png" align="right" width="50%"></div>
...
<form>
    ...
    <!-- <colgroup>
     ...
     <h5 style="background: gainsboro; width: 10%; text-align: center;" >BSIT Lists</h5>
...
<div class="text-right">
    <a href="export_it.php" class="btn btn-link" target="_blank" onclick="return confirm('Do you want to Export data to Microsoft Excel?');">EXPORT TO EXCEL?</a>
</div>
</div>
   </div>
